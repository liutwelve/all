		...
		*/
		...
		.on('click','.edit',function(e) {//同时绑定edit click事件
			...
			var p=$(this).parent().parent(),
				...
				console.log('是我',$(this).parent().parent().data('type'))
			if($(this).parent().parent().data('type')=="iopAdvertisement"){ //底部按钮非公共保存的判断
				console.log('进来了',type)
				$('.modals').hide()
				$('.modalsIop').fadeIn(200, function() {
			...
			console.log('到这里了啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊從')
